...
func TestFilterExprLogs(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedArgs:          []any{"u@example.com"},
			expectedErrorContains: "",
		},
		{
			category:              "Key with @symbol",
		...
		},
		{
			...
			expectedArgs:          []any{"जब तक इस देश में सिनेमा है"},
			expectedErrorContains: "",
		},
		...
		// Typical queries that combine FREETEXT with other constructs
		{
			...
			expectedArgs:          []any{"critical", "resolved", "open"},
			expectedErrorContains: "",
		},
		{
		...
		},
		{
			...
			expectedArgs:          []any{"database", "error", "mysql"},
			expectedErrorContains: "",
		},
		{
			category:              "FREETEXT with conditions",
			...
			expectedArgs:          []any{"connection timeout", float64(30)},
			expectedErrorContains: "",
		},
		{
			category:              "FREETEXT with conditions",
			...
			expectedArgs:          []any{"warning", "critical"},
			expectedErrorContains: "",
		},
		{
			category:              "FREETEXT with conditions",
		...
		// NOT EXISTS
		{
			...
			shouldPass:            true,
			expectedQuery:         "WHERE NOT mapContains(attributes_string, 'user.id')",
			expectedArgs:          nil,
			expectedErrorContains: "",
		},
		{
		...
		},
		{
			...
			shouldPass:            true,
			expectedQuery:         "WHERE NOT mapContains(attributes_string, 'metadata.version')",
			expectedArgs:          nil,
			expectedErrorContains: "",
		},
		{
			...
			shouldPass:            true,
			expectedQuery:         "WHERE NOT mapContains(attributes_string, 'request.headers.authorization')",
			expectedArgs:          nil,
			expectedErrorContains: "",
		},
		{
			...
			shouldPass:            true,
			expectedQuery:         "WHERE NOT mapContains(attributes_string, 'response.body.data')",
			expectedArgs:          nil,
			expectedErrorContains: "",
		},
		{
		...
		},
		{
			...
			expectedArgs:          []any{float64(0), float64(1000)},
			expectedErrorContains: "",
		},
		{
			category:              "Explicit AND",
		...
		},
		{
			...
			expectedArgs:          []any{float64(10), float64(100)},
			expectedErrorContains: "",
		},
		...
		},
		{
			...
			expectedArgs:          []any{float64(10), float64(100), float64(1000), float64(5000)},
			expectedErrorContains: "",
		},
		{
			category:              "AND + OR combinations",
			...
			expectedArgs:          []any{"ERROR", "WARN", "%timeout%"},
			expectedErrorContains: "",
		},
		...
		},
		{
			...
			expectedArgs:          []any{"ERROR", "FATAL", "%expected%"},
			expectedErrorContains: "",
		},
		{
			category:              "AND + OR + NOT combinations",
		...
		},
		{
			...
			expectedArgs:          []any{float64(0), "ERROR", "%error%"},
			expectedErrorContains: "",
		},
		...
		},
		{
			...
			shouldPass:            true,
			expectedQuery:         "WHERE (((((toFloat64(attributes_number['count']) > ? AND mapContains(attributes_number, 'count')) AND (toFloat64(attributes_number['count']) < ? AND mapContains(attributes_number, 'count')))) OR (((toFloat64(attributes_number['duration']) > ? AND mapContains(attributes_number, 'duration')) AND (toFloat64(attributes_number['duration']) < ? AND mapContains(attributes_number, 'duration'))))))",
			expectedArgs:          []any{float64(0), float64(100), float64(1000), float64(5000)},
			expectedErrorContains: "",
		},
		{
			category:              "Complex nested grouping",
			...
			expectedArgs:          []any{"ERROR", "WARN", "%timeout%", "%connection%"},
			expectedErrorContains: "",
		},
		...
		},
		{
			...
			expectedArgs:          []any{"This is a \\\"quoted\\\" message"},
			expectedErrorContains: "",
		},
		{
			category:              "String quote styles",
		...
		},
		{
			...
			expectedArgs:  []any{"Это тестовое сообщение"},
		},
		...
		},
		{
			...
			expectedArgs:  []any{"?param1=value1&param2=value2"},
		},
		...
		// Special characters in keys
		{
			...
			expectedArgs:  []any{"value"}, // With hyphen
		},
		{
			category:      "Special characters in keys",
			query:         "special.key=\"value\"",
			shouldPass:    true,
			expectedQuery: "WHERE (attributes_string['special.key'] = ? AND mapContains(attributes_string, 'special.key'))",
			expectedArgs:  []any{"value"}, // With dot
		},
		{
			category:      "Special characters in keys",
			...
			expectedArgs:  []any{"value"}, // With underscore
		},
		...
		// Common filter patterns
		{
			...
			expectedArgs:  []any{"pending", "processing", "completed", true},
		},
		{
			category:      "Common filters",
			...
			expectedArgs:  []any{"John%", "Smith%", float64(18)},
		},
		{
			category:              "Common filters",
		...
		},
		{
			...
			shouldPass:    true,
			expectedQuery: "WHERE (attributes_string['path'] = ? AND mapContains(attributes_string, 'path'))",
			expectedArgs:  []any{"C:\\Program Files\\Application"},
		},
		{
			category:      "Escaped values",
			...
			shouldPass:    true,
			expectedQuery: "WHERE (attributes_string['path'] = ? AND mapContains(attributes_string, 'path'))",
			expectedArgs:  []any{"^prefix\\.suffix$\\d+\\w+"},
		},
