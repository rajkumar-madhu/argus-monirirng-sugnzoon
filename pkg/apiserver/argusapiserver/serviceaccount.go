...
func (provider *provider) addServiceAccountRoutes(router *mux.Router) error {
	if err := router.Handle("/api/v1/service_accounts", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.Create, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_accounts", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.List, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_accounts/{id}", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.Get, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_accounts/{id}/roles", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.GetRoles, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_accounts/{id}", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.Update, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_accounts/{id}", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.Delete, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_accounts/{id}/keys", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.CreateFactorAPIKey, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_accounts/{id}/keys", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.ListFactorAPIKey, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_accounts/{id}/keys/{fid}", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.UpdateFactorAPIKey, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_accounts/{id}/keys/{fid}", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.RevokeFactorAPIKey, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_account_roles", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.CreateServiceAccountRole, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_account_roles/{id}", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.GetServiceAccountRole, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
	...
	if err := router.Handle("/api/v1/service_account_roles/{id}", handler.New(
		provider.authzMiddleware.CheckResources(provider.serviceAccountHandler.DeleteServiceAccountRole, authtypes.ArgusAdminRoleName),
		handler.OpenAPIDef{
