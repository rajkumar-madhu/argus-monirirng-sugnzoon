...
https://argus.example.com/alerts/123
...
[View Alert in Argus](https://argus.example.com/alerts/123) | [View Logs](https://argus.example.com/logs?service=api-gateway) | [View Traces](https://argus.example.com/traces?service=api-gateway)

![critical](https://argus.example.com/badges/critical.svg "Critical Alert")
...
This alert was generated by Argus using ` + "`alertmanager`" + ` rules engine.
`
...
func TestRenderHTML_Composite(t *testing.T) {
	...
	expected := "<h1>🔥 FIRING: High CPU Usage on api-gateway</h1>\n" +
		...
		"<p><a href=\"https://argus.example.com/alerts/123\">View Alert in Argus</a> | <a href=\"https://argus.example.com/logs?service=api-gateway\">View Logs</a> | <a href=\"https://argus.example.com/traces?service=api-gateway\">View Traces</a></p>\n" +
		"<p><img src=\"https://argus.example.com/badges/critical.svg\" alt=\"critical\" title=\"Critical Alert\"></p>\n" +
		"<h2>Alert Labels</h2>\n" +
		"<table>\n<thead>\n<tr>\n<th>Label</th>\n<th>Value</th>\n</tr>\n</thead>\n" +
		"<tbody>\n<tr>\n<td>service</td>\n<td>api-gateway</td>\n</tr>\n" +
		"<tr>\n<td>instance</td>\n<td>pod-5a8b3c</td>\n</tr>\n" +
		...
		"<p>This alert was generated by Argus using <code>alertmanager</code> rules engine.</p>\n"
...
Metric ` + "`cpu_usage_percent`" + ` exceeded threshold. [View in Argus](https://argus.example.com/alerts/123)
...
![critical](https://argus.example.com/badges/critical.svg "Critical Alert")`
	...
	expected := "<h1>🔥 FIRING: High CPU on api-gateway</h1>\n<h2>Alert Status</h2>\n" +
		...
		"<p>Metric <code>cpu_usage_percent</code> exceeded threshold. <a href=\"https://argus.example.com/alerts/123\">View in Argus</a></p>\n" +
		"<p><img src=\"https://argus.example.com/badges/critical.svg\" alt=\"critical\" title=\"Critical Alert\"></p>\n"
