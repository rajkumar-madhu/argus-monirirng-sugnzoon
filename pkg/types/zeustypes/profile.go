...
type PostableProfile struct {
	...
	ReasonsForInterestInArgus    []string `json:"reasons_for_interest_in_signoz" required:"true"`
	...
	WhereDidYouDiscoverArgus     string   `json:"where_did_you_discover_signoz" required:"true"`
	TimelineForMigratingToArgus  string   `json:"timeline_for_migrating_to_signoz" required:"true"`
}
