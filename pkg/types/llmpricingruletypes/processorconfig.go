...
func buildProcessorConfig(rules []*LLMPricingRule) *LLMPricingRuleProcessorConfig {
	...
	return &LLMPricingRuleProcessorConfig{
		...
		OutputAttrs: LLMPricingRuleProcessorOutputAttrs{
			In:         aiobservabilitytypes.ArgusGenAICostInput,
			Out:        aiobservabilitytypes.ArgusGenAICostOutput,
			CacheRead:  aiobservabilitytypes.ArgusGenAICostCacheRead,
			CacheWrite: aiobservabilitytypes.ArgusGenAICostCacheWrite,
			Total:      aiobservabilitytypes.ArgusGenAITotalCost,
		},
	}
}
