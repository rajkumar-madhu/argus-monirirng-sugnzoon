...
def seeder(
    ...
    def create() -> types.TestContainerDocker:
        ...
        container.with_env("CH_USER", clickhouse.env["ARGUS_TELEMETRYSTORE_CLICKHOUSE_USERNAME"])
        container.with_env("CH_PASSWORD", clickhouse.env["ARGUS_TELEMETRYSTORE_CLICKHOUSE_PASSWORD"])
        container.with_env("CH_CLUSTER", clickhouse.env["ARGUS_TELEMETRYSTORE_CLICKHOUSE_CLUSTER"])
