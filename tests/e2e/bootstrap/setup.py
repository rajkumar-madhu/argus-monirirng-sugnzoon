...
def _env_file(pytestconfig: pytest.Config) -> Path:
    override = os.environ.get("ARGUS_E2E_ENV_FILE")
    if override:
...
def test_setup(
    ...
    with out.open("w") as f:
        ...
        f.write(f"ARGUS_E2E_BASE_URL={host_cfg.base()}\n")
        f.write(f"ARGUS_E2E_USERNAME={USER_ADMIN_EMAIL}\n")
        f.write(f"ARGUS_E2E_PASSWORD={USER_ADMIN_PASSWORD}\n")
        f.write(f"ARGUS_E2E_SEEDER_URL={seeder_cfg.base()}\n")
