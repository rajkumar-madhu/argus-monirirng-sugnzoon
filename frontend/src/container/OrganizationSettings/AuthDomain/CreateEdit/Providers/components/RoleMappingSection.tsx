						...
						>
							...
							<div className="role-mapping-section__collapse-header-text">
								...
								<p className="role-mapping-section__section-description">
									...
									You can either use a direct role attribute or map IDP groups to WeCrew
									roles.
								</p>
							</div>
							{!expanded && hasErrors && (
				...
				>
					<div id="role-mapping-content" className="role-mapping-section__content">
						...
						<div className="role-mapping-section__checkbox-row">
							...
							<Tooltip title="If enabled, the role claim/attribute from the IDP will be used directly instead of group mappings. The value must match an existing role’s internal name, which may differ from its display name in WeCrew.">
								<CircleHelp size={14} color={Style.L3_FOREGROUND} cursor="help" />
							</Tooltip>
						</div>
							...
							<div className="role-mapping-section__group-mappings">
								<div className="role-mapping-section__group-header">
									...
									<p className="role-mapping-section__group-description">
										Map IDP group names to WeCrew roles. If a user belongs to multiple
