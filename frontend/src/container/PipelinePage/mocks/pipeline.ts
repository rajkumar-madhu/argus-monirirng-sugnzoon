...
export const pipelineMockData: Array<PipelineData> = [
	{
		...
		createdBy: 'nityananda@argus.example.com',
	...
	},
	{
		...
		createdBy: 'chintan@argus.example.com',
...
export const pipelineApiResponseMockData: Pipeline = {
	...
	createdBy: 'test@argus.example.com',
	active: false,
	is_valid: false,
	disabled: false,
	...
	history: [
		{
			...
			version: 1,
			elementType: 'log_pipelines',
			createdBy: 'test2@argus.example.com',
			active: false,
			isValid: false,
			disabled: false,
		...
		},
		{
			...
			version: 2,
			elementType: 'log_pipelines',
			createdBy: 'test3@argus.example.com',
			active: false,
			isValid: false,
			disabled: false,
			deployStatus: 'DEPLOYED',
		...
		},
		{
			...
			version: 3,
			elementType: 'log_pipelines',
			createdBy: 'nityananda+1@argus.example.com',
			active: false,
			isValid: false,
			disabled: false,
			deployStatus: 'IN_PROGRESS',
		...
		},
		{
			...
			version: 4,
			elementType: 'log_pipelines',
			createdBy: 'nityananda+2@argus.example.com',
			active: false,
			isValid: false,
			disabled: false,
			deployStatus: 'IN_PROGRESS',
		...
		},
		{
			...
			version: 5,
			elementType: 'log_pipelines',
			createdBy: 'nityananda+4@argus.example.com',
			active: false,
			isValid: false,
			disabled: false,
			deployStatus: 'IN_PROGRESS',
