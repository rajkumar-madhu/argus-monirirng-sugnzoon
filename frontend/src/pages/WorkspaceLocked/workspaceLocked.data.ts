export const infoData = [
	...
	},
	{
		...
		description:
			'Hundreds of companies ⎯from early-stage start-ups to public enterprises use Argus to build more reliable products.',
	},
];
...
export const customerStoriesData = [
	{
		...
		customerName: 'Convoy',
		message:
			"We use OTel with Argus to spot redundant database connect calls. For example, we found that our database driver wasn't using the connection pool even though the documentation claimed otherwise.",
		link:
	...
	},
	{
		...
		customerName: 'Nudge',
		message:
			'Argus is one of the best observability tools you can self-host hands down. And they are always there to help on their slack channel when needed.',
		link:
	...
	},
	{
		...
		message:
			'We use Argus and have been loving it - can definitely handle scale.',
	...
	},
	{
		...
		customerName: 'Azodha',
		message:
			'Recently moved metrics and logging to Argus. Gotta say, absolutely loving the tool.',
	...
	},
	{
		...
		customerName: '',
		message:
			"But wow, I'm glad I tried Argus. Setting up Argus was easy—they provide super helpful instructions along with a docker-compose file.",
		link:
	...
	},
	{
		...
		message:
			'Monitoring done. Thanks to Argus, I don’t have to deal with Grafana, Loki, Prometheus, and Jaeger separately.',
...
export const faqData = [
	{
		...
		label:
			'What is the difference between Argus Cloud(Teams) and Community Edition?',
		children:
			'You can self-host and manage the community edition yourself. You should choose Argus Cloud if you don’t want to worry about managing the Argus cluster. There are some exclusive features like SSO & SAML support, which come with Argus cloud offering. Our team also offers support on the initial configuration of dashboards & alerts and advises on best practices for setting up your observability stack in the Argus cloud offering.',
	},
	{
		key: 'calc-for-metrics',
		label: 'How are number of samples calculated for metrics pricing?',
		children:
			"If a timeseries sends data every 30s, then it will generate 2 samples per min. So, if you have 10,000 time series sending data every 30s then you will be sending 20,000 samples per min to Argus. This will be around 864 mn samples per month and would cost 86.4 USD/month. Here's an explainer video on how metrics pricing is calculated - Link: https://vimeo.com/973012522",
	},
	{
